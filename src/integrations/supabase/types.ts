  ...
  public: {
    Tables: {
      audit_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "audit_log_organizer_id_fkey"
      ...
      tournaments: {
        Row: {
          ...
          nome: string
          organizer_id: string
          tipo: Database["public"]["Enums"]["tournament_type"]
        }
        Insert: {
          coordinates: unknown
          created_at?: string
    ...
    Enums: {
      audit_action: "edit" | "delete"
      tournament_type: "5" | "7" | "11"
